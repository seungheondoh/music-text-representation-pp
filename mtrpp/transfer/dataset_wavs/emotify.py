...
class EMOTIFY_Dataset(Dataset):
    ...
    def get_split(self):
        track_split = json.load(open(os.path.join(self.data_path, "emotify", "track_split.json"), "r"))
    ...
    def get_file_list(self):
        annotation = json.load(open(os.path.join(self.data_path, "emotify", "annotation.json"), 'r'))
        self.list_of_label = json.load(open(os.path.join(self.data_path, "emotify", "emotify_tags.json"), 'r'))
    ...
    def audio_load(self, path):
        audio_path = os.path.join(self.data_path, "emotify", "audio", path)
        audio, _ = load_audio(
            path=audio_path,
